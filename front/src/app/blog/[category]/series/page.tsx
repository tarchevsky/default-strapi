		...
		<>
			...
			<div className='cont md:py-16'>
				...
				<p className='prose'>
					...
					которую вы сейчас или в будущем будете изучать с психологом. Здесь
					важна система и последовательность - поэтому выбрав ту или иную серию,
					вы всегда сможете вернуться к изученному материалу и повторно обдумать,
